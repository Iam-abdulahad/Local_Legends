    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      >
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <label className="block text-[#7D0A0A] font-medium mb-1">Your Name</label>
            <input
              type="text"
              name="name"
              value={formData.name}
        ...
        <div>
          <label className="block text-[#7D0A0A] font-medium mb-1">Story Title</label>
          <input
            type="text"
            name="title"
        ...
        <div>
          <label className="block text-[#7D0A0A] font-medium mb-1">Location</label>
          <input
            type="text"
            name="location"
        ...
        <div>
          <label className="block text-[#7D0A0A] font-medium mb-1">Story Details</label>
          <textarea
            name="story"
